...
public class BlurRenderer {
    ...
    public BlurRenderer(View view) {
        ...
        // RenderScript related variables ScriptC_StackBlur(mRS);
//        mRS = RenderScript.create(view.getContext());
        mRS = androidx.renderscript.RenderScript.create(view.getContext());
    ...
    public void setBlurRadius(int radius) {
        ...
        // Prepare dv allocation Element.U8(mRS)
